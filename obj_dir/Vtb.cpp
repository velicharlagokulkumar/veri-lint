...
void Vtb___024root__trace_init_top(Vtb___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vtb::trace(VerilatedFstC* tfp, int levels, int options) {
    if (tfp->isOpen()) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vtb::trace()' shall not be called after 'VerilatedFstC::open()'.");
    }
